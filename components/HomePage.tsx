...
const HomePage: React.FC<HomePageProps> = ({ onStart }) => {
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center text-center py-16 md:py-24 overflow-hidden">
      ...
      {/* Background image collage for desktop */}
      ...
      <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-800 leading-tight z-10">
            Plongez dans l'univers<br/>
            mystérieux des <span className="relative inline-block">
          ...
          <p className="mt-6 text-lg text-gray-500 max-w-2xl mx-auto italic z-10">
